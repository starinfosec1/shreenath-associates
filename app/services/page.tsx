...
const servicesList = [
    ...
    },
    {
        ...
        "docs": [
            "पॅन कार्ड (सिबिल दुरुस्तीसाठी अनिवार्य)",
            "आधार कार्ड",
            "पासपोर्ट",
            "मतदार ओळखपत्र (Voter ID)",
            "मोबाईल नंबर (बँकेशी लिंक असलेला)",
            "ई-मेल आयडी",
            "चालू सिबिल रिपोर्ट (ज्यामध्ये त्रुटी किंवा चूक आहे)",
            "बँक पासबुक / बँक स्टेटमेंट (गेल्या ६ महिन्यांचे)",
            "नो ड्यूज सर्टिफिकेट (NOC) - कर्ज पूर्ण भरले असल्यास",
            "कर्ज खाते बंद केल्याचे प्रमाणपत्र (Closure Letter)",
            "कर्ज मंजुरी पत्र (Sanction Letter) - खात्याच्या अचूक माहितीसाठी",
            "कर्ज हप्ते भरल्याची पावती (Payment Receipts)",
            "बँक खाते तपशील विवरण (Loan Account Statement)",
            "नाव किंवा जन्मतारीख दुरुस्तीसाठी सरकारी गॅझेट (लागू असल्यास)",
            "बँकेचे अधिकृत पत्र (Dispute संदर्भात काही पत्रव्यवहार झाला असल्यास)",
            "पत्ता पुरावा (लाईट बिल / भाडे करारनामा)",
            "ओळखपत्राचा पुरावा"
        ],
